...
public class customadapterprogres extends ArrayAdapter<Quizanswer> implements View.OnClickListener{
    ...
    public customadapterprogres(ArrayList<Quizanswer> data, Context context, int resource) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent it = new Intent(getContext(),Graph.class);
